...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "T Shirts",
    colours: 3,
    images: ["/images/products/year-of-horse-tee.png"],
    description: "Heritage graphic tee with embroidered horse back print.",
  },
  {
    slug: "corex",
    name: "Corex",
    category: "T Shirts",
    colours: 2,
    images: ["/images/products/corex-tee.png"],
    description: "Bold front-print tee with a contrast side panel.",
  },
  {
    slug: "new-cast",
    name: "New Cast",
    category: "T Shirts",
    colours: 2,
    images: ["/images/products/newcast-tee.png"],
    description: "Oversized tee with a bold back-print typographic design.",
  },
  {
    slug: "linen-set",
    name: "Linen Set",
